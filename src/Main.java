...
//        }
        ...
        //------------------------------------- Вывод списка дисциплин (для себя) --------------------------------------
//                                                              РАБОТАЕТ!
//        eff.printSchedule();
//        hf.printSchedule();
//        irf.printSchedule();
//        mmf.printSchedule();
        ...
        // возможно тоже нужно поработать над неймингом, а также рассмотреть возможность добавления групп
...
//        }
        ...
        //ВОЗМОЖНО НУЖНО ДОБАВЛЯТЬ СТУДЕНТОВ В ГРУППУ ИНАЧЕ!!!!!!!!!!!!!!!!!!!!
        Student student = new Student("ПУТИН");
        hf1.addStudent(student);
        System.out.println(student.getSchedule());
//        student.setMarkForDiscipline();
...
//        mmf2.addStudent(new Student("Мамехин М.М"), new Student("Мамонов Д.С"), new Student("Егоров Е.А."), new Student("Хомченко С.С."));
        //------------------------------------------ выставляем оценки по предметам ------------------------------------
//        try {
